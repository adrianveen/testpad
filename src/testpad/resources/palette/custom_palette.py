...
def load_custom_palette(palette_name: str) -> Tuple[QtGui.QPalette, str]:
    ...
    if palette_name == 'dark_palette':
        ...
        # Links & selections
        palette.setColor(QtGui.QPalette.ColorRole.Link, QtGui.QColor(49, 84, 72))            # green-ish
        palette.setColor(QtGui.QPalette.ColorRole.Highlight, QtGui.QColor(49, 84, 72))       # green-ish
        palette.setColor(QtGui.QPalette.ColorRole.HighlightedText, QtGui.QColor(230, 230, 230))

        # Disabled state tweaks
        palette.setColor(QtGui.QPalette.ColorGroup.Active, QtGui.QPalette.ColorRole.Button, QtGui.QColor(53, 53, 53))
        palette.setColor(QtGui.QPalette.ColorGroup.Disabled, QtGui.QPalette.ColorRole.ButtonText, QtCore.Qt.GlobalColor.darkGray)
        palette.setColor(QtGui.QPalette.ColorGroup.Disabled, QtGui.QPalette.ColorRole.WindowText, QtCore.Qt.GlobalColor.darkGray)
        palette.setColor(QtGui.QPalette.ColorGroup.Disabled, QtGui.QPalette.ColorRole.Text, QtCore.Qt.GlobalColor.darkGray)
        palette.setColor(QtGui.QPalette.ColorGroup.Disabled, QtGui.QPalette.ColorRole.Light, QtGui.QColor(53, 53, 53))
