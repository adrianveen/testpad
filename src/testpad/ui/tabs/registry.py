"""Tab specifications and utilities."""
...
TABS_SPEC = [
    ...
    #     "create_burnin_tab",
    #     "Burn-in Graph Viewer",
    #     feature_flag="burnin_tab",
    # ),
    ...
    TabSpec(
        ...
        "create_degasser_tab",
        "Degasser Data",
        feature_flag="degasser_tab",
    ),
]


def enabled_tabs(
    specs: Iterable[TabSpec],
