"""Transducer Linear Tab View.

This module provides the user interface for the Transducer Linear Tab.
"""
...
class TransducerLinearTab(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        """Initialize the Transducer Linear tab."""
    ...
    def printGraphs(self):
        ...
        variables_dict = [
            ...
            self.save_graph.isChecked(),
            self.selected_save_folder,
            self.x_graph_box.isChecked(),
            self.y_graph_box.isChecked(),
            self.z_graph_box.isChecked(),
        ]
        x_graph, y_graph, z_graph = LinearScan(
            variables_dict, self.text_display
        ).getGraphs()
