...
class MatchingBoxTab(QWidget):
    """Matching Box Tab View."""

    def __init__(self, parent: QWidget | None) -> None:
        """Initialise the Matching Box Tab."""
    ...
    def getValues(self):
        ...
        text = self.new_match.calculations(
            freq,
            float(self.z_textbox.text()),
            float(self.phase_textbox.text()),
            AL_value,
        )
    ...
    def printCSVGraphs(self):
        ...
        impedance_graph, phase_graph = CSVGraph(
            self.freq_csv_field.text(),
            self.freq_csv_combobox.currentText(),
    ...
    def _apply_scale(self, factor: float):
        ...
        Scrollbars appear if it exceeds the viewport.
        """
        ...
        self.pixmap = self._source_pixmap.scaled(
            w,
            h,
