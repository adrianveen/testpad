...
class BurninStats:
    def __init__(self, burnin_file, textbox: QTextBrowser) -> None:
        ...
        self.negative_stats = None
        self.positive_stats = None
    ...
    def printStats(self):
        def calculate_stats(errors) -> tuple:
            """
        ...
        def display_stats(title, stats) -> list:
        ...
        self.positive_stats = calculate_stats(positive_errors)
        pos_listof_stats = display_stats(
        ...
        self.negative_stats = calculate_stats(negative_errors)
