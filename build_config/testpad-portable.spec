...
Build command:
    pyinstaller build_config/testpad-portable.spec --clean

Output:
    dist/testpad-portable.exe  (single executable with everything bundled)
...
exe = EXE(
    ...
    a.datas,
    [],
    name='testpad-portable',  # Output: testpad-portable.exe
    debug=False,
...
print(f"   Output will be: dist/testpad-portable.exe")
